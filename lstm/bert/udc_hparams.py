...
tf.flags.DEFINE_integer("max_context_len", 768, "Truncate contexts to this length")
tf.flags.DEFINE_integer("max_utterance_len", 768, "Truncate utterance to this length")
